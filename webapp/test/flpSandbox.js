		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#estadoCuentadulcor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"estadoCuentadulcor-display": {
								"semanticObject": "estadoCuentadulcor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=estadoCuenta.dulcor",
									"url": sap.ui.require.toUrl("estadoCuenta/dulcor")
								}
							}
						}
					}
